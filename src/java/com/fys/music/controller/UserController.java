...
public class UserController {
    @Autowired FMusicService userService;
     ...
     * 更新个性签名
     */
    @RequestMapping(value = "/updateSignature", produces="text/plain; charset=utf-8")
    ...
    public @ResponseBody String loginDeal(HttpServletRequest req, HttpServletResponse resp) {
        String username = req.getParameter("username");
        String password = req.getParameter("password");
